...
namespace M7.Match {
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "BGGamesCore/Match/ChainMethods/HorizontalAndVertical")]
    public class ChainMethodHorizontalAndVertical : ChainMethodBase {
        ...
        public override List<PointList<RectPoint>> FindChains(MatchGrid matchGrid, PointList<RectPoint> points) {
            List<PointList<RectPoint>> horizontalChains = chainMethodHorizontal.FindChains(matchGrid, points);
            List<PointList<RectPoint>> verticalChains = chainMethodVertical.FindChains(matchGrid, points);
